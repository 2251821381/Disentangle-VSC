...
class HParams(object):
  ...
  A `HParams` object holds hyperparameters used to build and train a models,
  ...
  ```python
  # Create a HParams object specifying names and values of the models
  # hyperparameters:
  ...
  import argparse
  parser = argparse.ArgumentParser(description='Train my models.')
  ...
  def to_json(self, indent=None, separators=None, sort_keys=False):
    ...
    Args:
      ...
      separators: Optional `(item_separator, key_separator)` tuple. Default is
        `(', ', ': ')`.
      sort_keys: If `True`, the preprocessed dictionaries will be sorted by key.
