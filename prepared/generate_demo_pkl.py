...
mel_dir = '../dataset/VCTK/dataset/spmel'
f0_dir = '../dataset/VCTK/dataset/raptf0'
...
def make_test_metadata(subdirList):
    ...
    for speaker in sorted(subdirList):
        ...
        index, a_index, accent = get_speaker_id(speaker)

        spkid[index] = 1
        # one-hot
        spkid = spkid[np.newaxis, :]
        # speaker embedding
...
if __name__ == '__main__':
    ...
    demo_name = '{}_{}_{}_{}_{}_test'.format(source_speaker.split('_')[1], source_speaker.split('_')[0], speakers[0][3],
                                             target_speaker.split('_')[0], speakers[1][3])
